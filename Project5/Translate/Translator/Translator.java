...
public class Translator
{
 ...
 return null; 
  ...
  public Translate.Translate.Exp visit(AssignStmt e){
	...
	Translate.Tree.Exp right = e.lhs.accept(this).unEx();
...
public Translate.Tree.Exp sequenceSubTree(java.util.LinkedList<Stmt> list, int index)
{
  ...
  public Translate.Translate.Exp visit(CallExpr e){
	Translate.Tree.Exp func = e.target.accept(this);
	java.util.ArrayList<Translate.Translate.Exp> argsList = new java.util.ArrayList<Translate.Translate.Exp>();
	for (int i=0;i<e.args.size();i++)
	{ argsList.add(e.args.get(i).accept(this)); }
 	return new CALL(func,argsList); 
  }
 ...
 return null; 
  ...
  public Translate.Translate.Exp visit(MethodDecl e){
	...
	if(e.name.equals("main")){
		currFrame = type.newFrame(new Label(e.name), e.params.size());
	}else{
